...
//    private static final String URL = "jdbc:sqlserver://localhost:1433;DatabaseName=AChatDB;encrypt=true;trustServerCertificate=true", USERNAMEDB = "sa", PASSWORDDB = "";
    ...
    public static PreparedStatement setQuery(String Query)      {
        try{    return con.prepareStatement(Query); }
            ...
            System.out.println("!!! Error trying to set query. !!!");
            throw new RuntimeException(e);
        }
    ...
    public static ResultSet executeQuery(PreparedStatement ps)  {
        try{    return ps.executeQuery();   }
            ...
            System.out.println("!!! Error trying to execute query. !!!");
            throw new RuntimeException(e);
        }
    ...
    public static void insertUS(User user)                      {
        try {
            ...
            ps.close();
        } catch (SQLException ex) { System.out.println("!!! Error trying to Insert User to database. !!!");}
    ...
    public static User selectUS(String Username)                {
        try {
            ...
            System.out.println("!!! Error trying to Select User from database. !!!");
            throw new RuntimeException(e);}
    ...
    public static User selectUSbyMail(String mail)              {
        try {
            ...
            System.out.println("!!! Error trying to Select User by Mail from database. !!!");
            throw new RuntimeException(e);}
    ...
    public static void updateUS(User user)                      {
        try {
            ...
            ps.close(); 
        } catch (SQLException ex) { System.out.println("!!! Error trying to Update User to database. !!!");}
    ...
    public static void deleteUS()                               {
        try {
            ...
            ps.close(); 
        } catch (SQLException ex) { System.out.println("!!! Error trying to Delete User from database. !!!");}
    ...
    public static void insertID(int PortID, String IPAddress)   {
        try {
            ...
            ps.close();
        } catch (SQLException ex) { System.out.println("!!! Error trying to Insert ID to database. !!!");}
    }
    public static String selectIP(int PortID)                   {
        try {
            ...
            System.out.println("!!! Error trying to Select PortID from database. !!!"); throw new RuntimeException(e);}
    }
    ...
    public static void updateID(int PortID, boolean Available)  {
        try {
            ...
            ps.close(); 
        } catch (SQLException ex) { System.out.println("!!! Error trying to Update ID from database. !!!");}
    }
    public static void deleteID(int PortID)                     {
        try {
            ...
            ps.close(); 
        } catch (SQLException ex) { System.out.println("!!! Error trying to Delete ID from database. !!!");}
    }
}